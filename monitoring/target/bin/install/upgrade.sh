...
CONF_FOLDER=/usr/share/tb-monitoring/conf
configfile=tb-monitoring.conf
jarfile=/usr/share/tb-monitoring/bin/tb-monitoring.jar
installDir=/usr/share/tb-monitoring/data
...
su -s /bin/sh -c "java -cp ${jarfile} $JAVA_OPTS -Dloader.main=org.thingsboard.server.ThingsboardInstallApplication \
                    ...
                    -Dlogging.config=/usr/share/tb-monitoring/bin/install/logback.xml \
